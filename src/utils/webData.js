const WebData = [
  {
    title: "Virtual Acystant",
    link: "https://virtual-acystant.herokuapp.com/",
    gitHubLink: "https://github.com/themancalledzac/virtual-acystant",
    paragraph:
      "Machine learning application that can make a prediction of a user's skin damage based on an image that the user uploads.",
    role: "Project lead, including building the majority of the front end.",
  ...
  },
  {
    ...
    link: "https://react-employee-directory-edens.herokuapp.com/",
    gitHubLink: "https://github.com/themancalledzac/react-employee-directory",
    paragraph:
      "Using react, our initial exposure to this framework included breaking this application into components, multiple pages through Routes, and passing proper data down where applicable.",
    role: "Personal Project.",
    technology: "Javascript, React, Bootstrap, Axios",
    image01: {
